...
fn eexec_end(program: &[u8]) -> Option<usize> {
    ...
    let mut end = pos + 5;
    while end < program.len() && matches!(program[end], b'\r' | b'\n' | b' ' | b'\t') {
        end += 1;
        if program[end - 1] == b'\n' {
            break;
        }
...
mod tests {
    ...
    fn glyph_names_to_unicode() {
        ...
        assert_eq!(
            glyph_to_unicode("quotedblleft").as_deref(),
            Some("\u{201c}")
        );
    ...
    if let Some(hex) = base.strip_prefix("uni") {
        if !hex.is_empty() && hex.len() % 4 == 0 && hex.chars().all(|c| c.is_ascii_hexdigit()) {
            ...
            for k in (0..hex.len()).step_by(4) {
                let c = u32::from_str_radix(&hex[k..k + 4], 16)
                    .ok()
...
static GLYPH_LIST: &[(&str, &str)] = &[
    ...
    ("Ezhreversed", "\u{01B8}"),
    ("F", "F"),
    ("FFIsmall", "\u{F766}\u{F766}\u{F769}"),
    ("FFLsmall", "\u{F766}\u{F766}\u{F76C}"),
    ("FFsmall", "\u{F766}\u{F766}"),
    ("FIsmall", "\u{F766}\u{F769}"),
    ("FLsmall", "\u{F766}\u{F76C}"),
    ("Fcircle", "\u{24BB}"),
    ("Fdotaccent", "\u{1E1E}"),
    ("Feharmenian", "\u{0556}"),
    ("Feicoptic", "\u{03E4}"),
    ...
    ("approxorequal", "\u{224A}"),
    ("araeaekorean", "\u{318E}"),
    ("araeakorean", "\u{318D}"),
    ("arc", "\u{2312}"),
    ("archleftdown", "\u{21B6}"),
    ("archrightdown", "\u{21B7}"),
    ...
    ("arrowparrleftright", "\u{21C6}"),
    ("arrowparrrightleft", "\u{21C4}"),
    ("arrowright", "\u{2192}"),
    ...
    ("arrowtailleft", "\u{21A2}"),
    ("arrowtailright", "\u{21A3}"),
    ("arrowtripleleft", "\u{21DA}"),
    ("arrowtripleright", "\u{21DB}"),
    ("arrowup", "\u{2191}"),
    ("arrowupdn", "\u{2195}"),
    ("arrowupdnbse", "\u{21A8}"),
    ...
    ("dblarrowdwn", "\u{21CA}"),
    ("dblarrowheadleft", "\u{219E}"),
    ("dblarrowheadright", "\u{21A0}"),
    ("dblarrowleft", "\u{21D4}"),
    ("dblarrowright", "\u{21D2}"),
    ("dblarrowup", "\u{21C8}"),
    ("dblbracketleft", "\u{27E6}"),
    ("dblbracketright", "\u{27E7}"),
    ("dbldanda", "\u{0965}"),
    ("dblgrave", "\u{F6D6}"),
    ("dblgravecmb", "\u{030F}"),
    ("dblintegral", "\u{222C}"),
    ...
    ("epsilontonos", "\u{03AD}"),
    ("equal", "="),
    ("equaldotleftright", "\u{2252}"),
    ("equaldotrightleft", "\u{2253}"),
    ("equalmonospace", "\u{FF1D}"),
    ("equalorfollows", "\u{22DF}"),
    ("equalorgreater", "\u{2A96}"),
    ("equalorless", "\u{2A95}"),
    ("equalorprecedes", "\u{22DE}"),
    ("equalorsimilar", "\u{2242}"),
    ("equalsdots", "\u{2251}"),
    ("equalsmall", "\u{FE66}"),
    ...
    ("fofanthai", "\u{0E1F}"),
    ("fofathai", "\u{0E1D}"),
    ("follownotdbleqv", "\u{2ABA}"),
    ("follownotslnteql", "\u{2AB6}"),
    ("followornoteqvlnt", "\u{22E9}"),
    ("follows", "\u{227B}"),
    ("followsequal", "\u{2AB0}"),
    ("followsorcurly", "\u{227D}"),
    ("followsorequal", "\u{227F}"),
    ("fongmanthai", "\u{0E4F}"),
    ("forall", "\u{2200}"),
    ("forces", "\u{22A9}"),
    ("forcesbar", "\u{22AA}"),
    ...
    ("gravetonecmb", "\u{0340}"),
    ("greater", ">"),
    ("greaterdbleqlless", "\u{2A8C}"),
    ("greaterdblequal", "\u{2267}"),
    ("greaterdot", "\u{22D7}"),
    ("greaterequal", "\u{2265}"),
    ("greaterequalorless", "\u{22DB}"),
    ("greaterlessequal", "\u{22DB}"),
    ("greatermonospace", "\u{FF1E}"),
    ("greatermuch", "\u{226B}"),
    ("greaternotdblequal", "\u{2A8A}"),
    ("greaternotequal", "\u{2A88}"),
    ("greaterorapproxeql", "\u{2A86}"),
    ("greaterorequalslant", "\u{2A7E}"),
    ("greaterorequivalent", "\u{2273}"),
    ("greaterorless", "\u{2277}"),
    ("greaterornotdbleql", "\u{2269}"),
    ("greaterornotequal", "\u{2269}"),
    ...
    ("harpoondownleft", "\u{21C3}"),
    ("harpoondownright", "\u{21C2}"),
    ("harpoonleftbarbup", "\u{21BC}"),
    ("harpoonleftright", "\u{21CC}"),
    ("harpoonrightbarbup", "\u{21C0}"),
    ("harpoonrightleft", "\u{21CB}"),
    ("harpoonupleft", "\u{21BF}"),
    ("harpoonupright", "\u{21BE}"),
    ("hasquare", "\u{33CA}"),
    ("hatafpatah", "\u{05B2}"),
    ("hatafpatah16", "\u{05B2}"),
    ("hatafpatah23", "\u{05B2}"),
    ...
    ("intercal", "\u{22BA}"),
    ("interrobang", "\u{203D}"),
    ("interrobangdown", "\u{2E18}"),
    ("intersection", "\u{2229}"),
    ("intersectiondbl", "\u{22D2}"),
    ...
    ("lessmuch", "\u{226A}"),
    ("lessnotdblequal", "\u{2A89}"),
    ("lessnotequal", "\u{2A87}"),
    ("lessorapproxeql", "\u{2A85}"),
    ("lessorequalslant", "\u{2A7D}"),
    ("lessorequivalent", "\u{2272}"),
    ("lessorgreater", "\u{2276}"),
    ("lessornotdbleql", "\u{2268}"),
    ("lessornotequal", "\u{2268}"),
    ...
    ("multimap", "\u{22B8}"),
    ("multiopenleft", "\u{22CB}"),
    ("multiopenright", "\u{22CC}"),
    ("multiply", "\u{00D7}"),
    ("mumsquare", "\u{339B}"),
    ("munahhebrew", "\u{05A3}"),
    ...
    ("notapproxequal", "\u{2247}"),
    ("notarrowboth", "\u{21AE}"),
    ("notarrowleft", "\u{219A}"),
    ("notarrowright", "\u{219B}"),
    ("notbar", "\u{2224}"),
    ("notcontains", "\u{220C}"),
    ("notdblarrowboth", "\u{21CE}"),
    ("notdblarrowleft", "\u{21CD}"),
    ("notdblarrowright", "\u{21CF}"),
    ("notelement", "\u{2209}"),
    ("notelementof", "\u{2209}"),
    ("notequal", "\u{2260}"),
    ("notexistential", "\u{2204}"),
    ("notfollows", "\u{2281}"),
    ("notfollowsoreql", "\u{2AB0}\u{0338}"),
    ("notforces", "\u{22AE}"),
    ("notforcesextra", "\u{22AF}"),
    ("notgreater", "\u{226F}"),
    ("notgreaterdblequal", "\u{2267}\u{0338}"),
    ("notgreaterequal", "\u{2271}"),
    ("notgreaternorequal", "\u{2271}"),
    ("notgreaternorless", "\u{2279}"),
    ("notgreaterorslnteql", "\u{2A7E}\u{0338}"),
    ("notidentical", "\u{2262}"),
    ("notless", "\u{226E}"),
    ("notlessdblequal", "\u{2266}\u{0338}"),
    ("notlessequal", "\u{2270}"),
    ("notlessnorequal", "\u{2270}"),
    ("notlessorslnteql", "\u{2A7D}\u{0338}"),
    ("notparallel", "\u{2226}"),
    ("notprecedes", "\u{2280}"),
    ("notprecedesoreql", "\u{2AAF}\u{0338}"),
    ("notsatisfies", "\u{22AD}"),
    ("notsimilar", "\u{2241}"),
    ("notsubset", "\u{2284}"),
    ("notsubseteql", "\u{2288}"),
    ("notsubsetordbleql", "\u{2AC5}\u{0338}"),
    ("notsubsetoreql", "\u{228A}"),
    ("notsucceeds", "\u{2281}"),
    ("notsuperset", "\u{2285}"),
    ("notsuperseteql", "\u{2289}"),
    ("notsupersetordbleql", "\u{2AC6}\u{0338}"),
    ("notsupersetoreql", "\u{228B}"),
    ("nottriangeqlleft", "\u{22EC}"),
    ("nottriangeqlright", "\u{22ED}"),
    ("nottriangleleft", "\u{22EA}"),
    ("nottriangleright", "\u{22EB}"),
    ("notturnstile", "\u{22AC}"),
    ("nowarmenian", "\u{0576}"),
    ("nparen", "\u{24A9}"),
    ("nssquare", "\u{33B1}"),
    ...
    ("piwrarmenian", "\u{0583}"),
    ("planckover2pi", "\u{210F}"),
    ("planckover2pi1", "\u{210F}"),
    ("plus", "+"),
    ("plusbelowcmb", "\u{031F}"),
    ("pluscircle", "\u{2295}"),
    ("plusminus", "\u{00B1}"),
    ...
    ("pparen", "\u{24AB}"),
    ("precedenotdbleqv", "\u{2AB9}"),
    ("precedenotslnteql", "\u{2AB5}"),
    ("precedeornoteqvlnt", "\u{22E8}"),
    ("precedes", "\u{227A}"),
    ("precedesequal", "\u{2AAF}"),
    ("precedesorcurly", "\u{227C}"),
    ("precedesorequal", "\u{227E}"),
    ("prescription", "\u{211E}"),
    ("prime", "\u{2032}"),
    ("primemod", "\u{02B9}"),
    ("primereverse", "\u{2035}"),
    ...
    ("subset", "\u{2282}"),
    ("subsetdbl", "\u{22D0}"),
    ("subsetdblequal", "\u{2AC5}"),
    ("subsetnoteql", "\u{228A}"),
    ("subsetnotequal", "\u{228A}"),
    ("subsetorequal", "\u{2286}"),
    ("subsetornotdbleql", "\u{2ACB}"),
    ...
    ("superset", "\u{2283}"),
    ("supersetdbl", "\u{22D1}"),
    ("supersetdblequal", "\u{2AC6}"),
    ("supersetnoteql", "\u{228B}"),
    ("supersetnotequal", "\u{228B}"),
    ("supersetorequal", "\u{2287}"),
    ("supersetornotdbleql", "\u{2ACC}"),
    ...
    ("triagup", "\u{25B2}"),
    ("triangle", "\u{25B3}"),
    ("triangledownsld", "\u{25BC}"),
    ("triangleinv", "\u{25BD}"),
    ("triangleleft", "\u{25C1}"),
    ("triangleleftequal", "\u{22B4}"),
    ("triangleleftsld", "\u{25C0}"),
    ("triangleright", "\u{25B7}"),
    ("trianglerightequal", "\u{22B5}"),
    ("trianglerightsld", "\u{25B6}"),
