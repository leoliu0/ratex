...
impl Prim {
    ...
    pub fn code(self) -> u16 {
        match self {
            ...
            Prim::XeTeXCountFeatures => 357,
            Prim::XeTeXFeatureCode => 358,
            Prim::XeTeXFeatureName => 359,
            Prim::XeTeXCountVariations => 360,
            Prim::XeTeXVariation => 361,
    ...
    pub fn from_code(c: u16) -> Option<Prim> {
        match c {
            ...
            357 => Some(Prim::XeTeXCountFeatures),
            358 => Some(Prim::XeTeXFeatureCode),
            359 => Some(Prim::XeTeXFeatureName),
            360 => Some(Prim::XeTeXCountVariations),
            361 => Some(Prim::XeTeXVariation),
