...
impl Lua {
    ...
    /// Create a Lua 5.3 state for LuaTeX-compatible execution.
    pub fn new_lua53(option: SafeOption) -> Self {
        Self::new_with_language(option, LuaLanguageLevel::Lua53)
    }
    ...
    /// Return the immutable language contract selected at construction.
    pub fn language(&self) -> LuaLanguageLevel {
        self.global_state_owner.language()
    }
